...
Refinar e alinhar o entendimento sobre o sistema da API existente, sua finalidade, cliente final e o produto da regra de negócio.

Este documento apresenta as estórias de usuário e os cenários em BDD para as principais funcionalidades testadas no desafio: autenticação, criação de reserva, consulta de reservas, atualização total, atualização parcial e exclusão de reserva.
